...
- `FrontendShellIntegrationTest`: verifies the generated frontend shell and compiled public assets are served by Spring Boot.
...
- public frontend bundle delivery
